  ...
  const textContent = visible && guestName ? (
    <>
      ...
      <h1 className="animate-fade-slide-up delay-2 font-great-vibes"
        style={{ fontSize: 'clamp(2.6rem, 8vw, 3.8rem)', lineHeight: 1.15, color: 'rgba(254,236,250,0.85)', margin: 0 }}>
        {guestName}!
      </h1>
      ...
      <p className="animate-fade-slide-up delay-4 font-cormorant"
        style={{ fontSize: 'clamp(1.16rem, 2.8vw, 1.3rem)', color: 'rgba(255,255,255,0.78)', fontStyle: 'italic', lineHeight: 1.55, maxWidth: 460 }}>
      ...
      <p className="animate-fade-slide-up delay-5 font-playfair"
        style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1.02rem)', color: 'rgba(255,255,255,0.5)', marginTop: '0.3rem' }}>
